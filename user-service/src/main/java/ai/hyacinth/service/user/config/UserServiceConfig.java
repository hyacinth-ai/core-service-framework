package ai.hyacinth.service.user.config;
...
import ai.hyacinth.service.user.service.UserService;
import ai.hyacinth.service.user.web.UserController;
...
@ComponentScan(
    basePackageClasses = {UserService.class, UserController.class, WebSecurityConfigurer.class}) // service and controller
@Import({EndpointConfig.class, JpaConfig.class, CacheConfig.class, DiscoveryConfig.class}) // support modules
